              ...
              {creations.map((creation, index) => (
                ...
                >
                  ...
                  <div className='absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4'>
                    ...
                    <p className='text-white text-sm font-medium line-clamp-2 translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75 mb-3'>
                       {creation.prompt}
                    </p>
                    ...
                    <div className='flex justify-between items-center w-full translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-100'>
                       <div className='flex items-center gap-2 bg-white/20 backdrop-blur-sm px-3 py-1.5 rounded-full'>
                          <span className='text-xs font-semibold text-white'>{creation.likes.length} likes</span>
                       </div>
